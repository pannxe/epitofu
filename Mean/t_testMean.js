...
function CalcTtest(data) {
  ...
  with (outTable) {
    ...
    newrow(
      "color#66ffff:span3:l:Two-sided confidence interval",
      "color#66ffff:span1:r:" + pt + "%",
      "color#66ffff:span4:l:"
    );
    newrow("color#66ffff:span8:l: &nbsp;  ");
    newrow(
      "color#ffff99:span2:l:",
      "color#ffff99:span1:bold:l: Sample size",
      "color#ffff99:span1:bold:c: Mean",
      "color#ffff99:span1:bold:c:Std. Dev.",
      "color#ffff99:span1:bold:c: Std. Error",
      "color#ffff99:span2:bold:l:"
    ); //to insert a new row;
    //newrow("color#ffff99:span8:l: &nbsp;  ");
    newrow(
      "color#ffff99::span2:l:Group-1",
      "color#ffff99:span1:c:" + n1,
      "color#ffff99:span1:c:" + mean1,
      "color#ffff99:span1:c:" + s1,
      "color#ffff99:span1:c:" + se1,
      "color#ffff99:span2:bold:l:"
    );
    newrow(
      "color#ffff99::span2:l:Group-2",
      "color#ffff99:span1:c:" + n2,
      "color#ffff99:span1:c:" + mean2,
      "color#ffff99:span1:c:" + s2,
      "color#ffff99:span1:c:" + se2,
      "color#ffff99:span2:bold:l:"
    );
    newrow("color#ffff99:span8:l: &nbsp;  ");
    ...
    newrow("span8:l: &nbsp;  ");
    newrow(
      "span2:l:bold:<u>Result:</u>",
      "span1:bold:c:<i>t</i>  statistics",
      "span1:bold:c:<i>df</i>",
      "span1:c:bold:p-value<tt><sup>1</sup>",
      "span1:bold:c:Mean Difference",
      "span1:bold:c:Lower Limit",
      "span1:bold:c:Upper Limit"
    );

    newrow(
      "span2:l:bold:Equal variance:",
      "span1:c:" + fmtSigFig(tstat, 6),
      "span1:c:" + df,
      "span1:c:" + fmtPValue(p),
      "span1:c:" + fmtSigFig(meandif, 6),
      "span1:c:" + fmtSigFig(ll, 6),
      "span1:c:" + fmtSigFig(ul, 6)
    );

    newrow(
      "span2:l:bold:Unequal variance:",
      "span1:c:" + fmtSigFig(t1, 6),
      "span1:c:" + df1,
      "span1:c:" + fmtPValue(p1),
      "span1:c:" + fmtSigFig(meandif1, 6),
      "span1:c:" + fmtSigFig(lll, 6),
      "span1:c:" + fmtSigFig(ull, 6)
    );
    ...
    newrow(
      "span3:l:bold:",
      "span1:bold:l:<i>F</i> statistics",
      "span2:c:bold:c:<i>df</i>(numerator,denominator)",
      "span2:c:bold:p-value<tt><sup>1</sup>"
    );
    newrow(
      "span3:l:bold:Test for equality of variance<tt><sup>2</sup>",
      "span1:l:" + fmtSigFig(f, 6),
      "span2:c:" + numerator + "," + denominator,
      "span2:c:" + fmtPValue(pf)
    ); //last one was fmtSigFig(pf,6)) fixed April 2009;

    newrow("span8:l: &nbsp;  ");
    line(8);
    newrow("span8:l: <tt><sup>1</sup></tt> <small> p-value (two-tailed)");
    newrow(
      "span8:l: <tt><sup>2</sup></tt> <small> Hartley's <i>f</i> test for equality of variance"
    );
