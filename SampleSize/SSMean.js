...
function CalcPower(data) {
  ...
  if (parseFloat(data[1].E2D2) == 0) {
    ...
    var ratio = parseFloat(data[1].E2D2);
  }
  //alert("ratio"+ratio);
  ...
  n1 = Math.ceil(
    ((Math.pow(s1, 2) + Math.pow(s2, 2) / ratio) * Math.pow(z + power, 2)) /
      Math.pow(diff, 2)
  );
  ...
  with (outTable) {
    ...
    newrow(
      "color#66ffff:span3:l:Confidence Interval  (2-sided)",
      "color#66ffff:span1:c:" + fmtSigFig(pt, 6) + "%",
      "color#66ffff:span3:l:"
    );
    newrow(
      "color#66ffff:span3:l:Power",
      "color#66ffff:span1:c:" + fmtSigFig(powerpt, 6) + "%",
      "color#66ffff:span3:l:"
    );
    newrow(
      "color#66ffff:span3:l:Ratio of sample size (Group 2/Group 1)",
      "color#66ffff:span1:c:" + fmtSigFig(ratio, 6),
      "color#66ffff:span3:l:"
    );
    newrow("color#66ffff:span7:l: &nbsp;  ");
    newrow(
      "color#ffff99:span2:l:",
      "color#ffff99:span1:bold:c: Group 1",
      "color#ffff99:span1:r:",
      "color#ffff99:span1:bold:c:Group 2",
      "color#ffff99:span1:c: ",
      "color#ffff99:span1:bold:c:Difference*"
    ); //to insert a new row;
    if (m1 == 0 && m2 == 0) {
      newrow(
        "color#ffff99::span2:l:Mean",
        "color#ffff99:span1:c:",
        "color#ffff99:span1:c:",
        "color#ffff99:span1:c:",
        "color#ffff99:span1:c:",
        "color#ffff99:span1:c:" + fmtSigFig(d, 6)
      );
    } else {
      newrow(
        "color#ffff99::span2:l:Mean",
        "color#ffff99:span1:c:" + fmtSigFig(m1, 6),
        "color#ffff99:span1:c:",
        "color#ffff99:span1:c:" + fmtSigFig(m2, 6),
        "color#ffff99:span1:c:",
        "color#ffff99:span1:c:" + fmtSigFig(m1 - m2, 6)
      );
    }
    newrow(
      "color#ffff99::span2:l:Standard deviation",
      "color#ffff99:span1:c:" + fmtSigFig(s1, 6),
      "color#ffff99:span1:c:",
      "color#ffff99:span1:c:" + fmtSigFig(s2, 6),
      "color#ffff99:span3:c:"
    );
    newrow(
      "color#ffff99::span2:l:Variance",
      "color#ffff99:span1:c:" + fmtSigFig(v1, 6),
      "color#ffff99:span1:c:",
      "color#ffff99:span1:c:" + fmtSigFig(v2, 6),
      "color#ffff99:span3:c:"
    );
    line(7);
    //newrow("span8:l: &nbsp; ");
