...
function arrayInfo(theArray) {
  ...
  dispStr +=
    "line[0] is itself an array, with elements line[0,0], line[0,1], etc.\n";
  dispStr +=
    "The number of items is line[0].length, in this case--" +
    theArray[0].length +
    "\n";
...
function handleSelect(textID) {
  ...
  var strSelection = element.value.substring(
  ...
  if (strSelection != "") {
    ...
    if (theArray.length == 1) {
      ...
      var colStats = colSummary(
        arrayFromString(element.value),
