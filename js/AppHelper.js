...
function useOpenEpiEntry(tblcmdarray1, tblcmdarray2, externalData) {
  ...
  if (tblcmdarray1 && tblcmdarray1.length > 0) {
    ...
    if (typeof configureInput == "undefined") {
      return;
    }
...
function htmlHeaderWithData(dataArray) {
  ...
  s += jsToHtml(
    dataToJSFunction(dataArray) +
      inputCmdsToJSFunction(etablecmds1, "etableCmds1") +
      inputCmdsToJSFunction(etablecmds2, "etableCmds2") +
      s1
  );
...
function writeFrontEnd(apptitle, authors, description, demofile) {
  ...
  fe += "</HEAD>";
  fe +=
    '<BODY onLoad="initPanels(1);translateHTML(document);" onUnload="closeWindows();" onBeforeUnload="closeWindows();">';
  ...
  if (currConfig() == "smartphone") {
    ...
    fe +=
      '<div id="tab0" style="color:blue;background-color:white;" class ="tab" onClick= "location.href=&#039;../menu/OE_Menu.htm&#039;">';
    fe += t("Menu");
    fe += "</div>";
  }
  fe +=
    '<div id="tab1" class="tab" onClick = "showPanel(1);" onMouseOver="hover(this);" onMouseOut="setState(1)">';
  fe += t("Start");
  fe += "</div>";
  fe +=
    '<div id="tab2" class="tab"' +
    'onClick = "useOpenEpiEntry();showPanel(2);" onMouseOver="hover(this);" onMouseOut="setState(2);">';
  fe += t("Enter");
  fe += "</div>";
  fe +=
    '<div id="tab3" class="tab" onClick = "callStatsIf(); showPanel(3);" onMouseOver="hover(this);" onMouseOut="setState(3);">';
  fe += t("Results");
  fe += "</div>";
  fe +=
    '<div id="tab4" class="tab" onClick = "showExWindow();showPanel(4);" onMouseOver="hover(this);" onMouseOut="setState(4)">';
  ...
  fe += "</div>";
  fe +=
    '<div id="tab5" class="tab" onClick = "location.href=&#39;../briefDoc/UsingOpenEpi.htm&#39;" onMouseOver="hover(this);" onMouseOut="setState(5)">';
  ...
  fe +=
    '<table width="100%" position:relative; border="0" cellspacing="0" cellpadding="0" bgcolor="#CCCCCC">';
  fe += '  <tr color="#FFFFFF">';

  //fe+='<div id="banner" style="background-color:#EEEEEE; color:#FFFFFF;">'
  fe +=
    '<td align="center" width="43%"  bgcolor="#EEEEEE"><span style="color:black">';
  fe += "<strong>" + t("Open Source Statistics for Public Health");
  fe += "</strong></span></td>";
  fe +=
    '<td align="center" width="15%" bgcolor="#EEEEEE"><a href="' +
    docfile +
  ...
  fe +=
    ...
    "</a></td>";
  fe +=
    '<td align="center" width="15%" bgcolor="#EEEEEE"><a href="../BriefDoc/About.htm" target="_blank">' +
    t("About") +
    "</a></td>";
  fe +=
    '<td align="center" width="15%" bgcolor="#EEEEEE"><a href="../BriefDoc/UsingOpenEpi.htm" target="_blank">' +
    t("Help") +
    "</a></td>";
  fe += "  </tr>";
  fe += "  </table>";
  ...
  fe +=
    '<input style="margin-bottom:5px;margin-top:5px;" name="btnEnter" type="button" id="btnEnter" value="' +
    t("Enter New Data") +
    '" onClick="useOpenEpiEntry();showPanel(2);return false"';
  fe +=
    '      style="text-align:center; background-color:#800000; color:white; font-family:arial; font-weight:bold; font-size:14pt;">';
  if (inscreenimg.length > 0) {
    fe +=
      '<br/><image name="inputscreen" width="80%" alt="Input screen image"  src="' +
      inscreenimg +
      '" border="0">';
  }
  ...
  if (outscreenimg.length > 0) {
    fe +=
      '<div id="outimg" style="text-align:center;"><p></p><image id="outputscreen" name="outputscreen" alt="Output screen image"  width="80%"  src="' +
      outscreenimg +
      '"  border="1"></p></div>';
  }
  /*
 if ((demofile.length>0) && (currConfig()!="smartphone"))
  ...
  fe +=
    '<div id="panel3" class="panel"><h2 align="left"><br/><br/>' +
    phr100 +
    "</h2></div>";
  var phr101 = t("It looks like there are no examples for this exercise.");
  fe +=
    '<div id="panel4" class="panel"><div id="NoExampleMsg"><h2>' +
    phr101 +
    "</h2></div></div>";
...
function showExWindow() {
  ...
  fe += "</head>";
  fe +=
    '<body  bgcolor="#FFFFFF" text="#336666" link="#009999" vlink="#66CCCC" alink="#00FFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="translateHTML();">';
  ...
  if (currConfig() != "smartphone") {
    //include the logo
    fe +=
      '<img src="../img/OpenEpi1.gif" name="image" width="184px" height="51px"></td>';
  }
  ...
  if (currConfig() != "smartphone") {
    ...
    fe +=
      '<table width="90%" border="0" cellspacing="4" cellpadding="2" align="left">';
  }
  fe += '<tr valign="middle">';
  ...
  if (currConfig() != "smartphone") {
    fe +=
      '<td width="150px" align="center" rowspan="2"> <img src="' +
      inscreenimg +
      '" name="image" width="350" height="204" border="0"><br>';
    fe += "</td>";
  }
  fe += "</tr>";
  ...
  if (Exercises != null) {
    fe += "<tr>";
    fe +=
      '<td bgcolor="#CCCCCC" colspan="2" align="center"> <h2>' +
      t("More Exercises") +
      "</h2></td>";
    fe += "</tr>";
    fe += "<tr>";
  ...
  fe += "<p>&nbsp;</p>";
  fe +=
    '<table width="96%" border="0" cellspacing="0" cellpadding="2px" bgcolor="#CCCCCC">';
  fe += "<tr> ";
  fe += "<td>&nbsp; </td>";
