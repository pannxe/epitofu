...
function showPanelAsWindow(panelNum) {
  ...
  HTMLforDiv +=
    "table{width:290px;background-color:#FFFFFF} tr{width:290px;} td{width=290px;}";
  HTMLforDiv += "</STYLE>";
  ...
  HTMLforDiv +=
    '<div id="tab0" class="tab" style="left: 2%;" onClick="closeMe();setTimeout(&quot;self.close()&quot;,1000);"> ';
  HTMLforDiv += "<strong>" + t("Menu*") + "</strong>" + "</div>";
  HTMLforDiv +=
    '<div id="tab1" class="tab" style="left: 18%;" onClick = "showPanelAsWindow(1);" onMouseOver="hover(this);" onMouseOut="setState(1)">';
  HTMLforDiv += t("Start*");
  HTMLforDiv += "</div>";
  ...
  HTMLforDiv +=
    '<div id="tab2" class="tab" style="left: 34%;" onClick = "showPanel(2);" onMouseOver="hover(this);" onMouseOut="setState(2);">';
  HTMLforDiv += t("Enter");
  HTMLforDiv += "</div>";
  HTMLforDiv +=
    '<div id="tab3" class="tab" style="left: 50%;"showPanel(3);" onMouseOver="hover(this);" onMouseOut="setState(3);">';
  HTMLforDiv += t("Results");
  HTMLforDiv += "</div>";
  HTMLforDiv +=
    '<div id="tab4" class="tab" style="left: 70%;" onClick = "showPanel(4);showExWindow();" onMouseOver="hover(this);" onMouseOut="setState(4)">';
  HTMLforDiv += t("Examples");
  HTMLforDiv += "</div>";
  HTMLforDiv +=
    '<div id="tab5" class="tab" style="left: 70%;" onClick = "showPanel(4);showExWindow();" onMouseOver="hover(this);" onMouseOut="setState(4)">';
  HTMLforDiv += t("Help");
  HTMLforDiv += "</div><br />";
  HTMLforDiv +=
  ...
  HTMLforDiv +=
    '<div id="banner" style="background-color:#EEEEEE; color:#FFFFFF;">';
  ...
  if (panelWin && panelWin.open) {
    panelWin.close();
  } //smartphone allows only one popup window
...
function insertCSS(cssFile) {
  cssString =
    '<style media="screen,projection" type="text/css">' + cssFile + "</style>";
