...
function Validate(legalarray, origargs, legalsonly) {
  ...
  for (i = 0; i < args.length; i++) {
    if (objType(args[i]) == "string") {
      arg = args[i].split(":");
      if (legalarray[arg[0]] == "") {
        //An associative array member exists for this arg
...
function groupBar() {
  ...
  var barwidth =
    this.width / this.hvalarray.length / (barsingroup + groupspacing);
...
function endGraph() {
  ...
  str +=
    "<table><tr><td><p><br><br><br><br><br><br><br><br><br><br>&nbsp;</p><p>&nbsp;</p>";
  str += "</td></tr></table></div>";
  for (
    var i = 0;
    i < this.bararray.length;
    i++
