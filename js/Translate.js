...
function initTranslation(requestedLang) {
  ...
  //	  }
  ffmsg =
    "If you are running OpenEpi in Firefox on local disk, enter ABOUT:CONFIG in Firefox's address bar.";
  ffmsg +=
    " Consent to the scary message. Find SECURITY.FILEURI.STRICT_ORIGIN_POLICY and double-click it ";
  ffmsg +=
    " to change the value to 'false'. This one-time setting restores Firefox 3.x Javascript function to that of ";
 ...
 */
  ...
  if (typeof T === "undefined") {
    ...
    return phrase;
  } else if (typeof T[phrase] != "undefined") {
