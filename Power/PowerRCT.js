...
function CalcPower(data) {
  ...
  with (outTable) {
    ...
    newrow(
      "color#66ffff:span4:bold:l:Sample size of Treatment Group 1",
      "color#ffff99:span4:c:" + fmtSigFig(n1, 6)
    );
    newrow(
      "color#66ffff:span4:bold:l:Percent with outcome in Treatment Group 1 (%)",
      "color#ffff99:span4:c:" + pp1
    ),
      newrow(
        "color#66ffff:span4:bold:l:Sample size of Treatment Group 2",
        "color#ffff99:span4:c:" + fmtSigFig(n2, 6)
      );
    newrow(
      "color#66ffff:span4:bold:l:Percent with outcome in Treatment Group 2 (%)",
      "color#ffff99:span4:c:" + pp2
    );
    newrow(
      "color#66ffff:span4:bold:l:Risk ratio detected",
