...
function CalcPower(data) {
  ...
  with (outTable) {
    ...
    newrow(
      "color#66ffff:span4:bold:l:Number of cases",
      "color#ffff99:span4:c:" + fmtSigFig(n1, 6)
    );
    newrow(
      "color#66ffff:span4:bold:l:Percent of exposure among cases (%)",
      "color#ffff99:span4:c:" + pp1
    ),
      newrow(
        "color#66ffff:span4:bold:l:Number of controls",
        "color#ffff99:span4:c:" + fmtSigFig(n2, 6)
      );
    newrow(
      "color#66ffff:span4:bold:l:Percent of exposure among controls (%)",
      "color#ffff99:span4:c:" + pp2
    );
    newrow(
      "color#66ffff:span4:bold:l:Odds Ratio",
      "color#ffff99:span4:c:" + fmtSigFig(or, 2)
    );
    line(8);
